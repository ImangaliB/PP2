        ...
        if event.type == pygame.QUIT:
            ...
            if event.button == 1:
                ...
                if mode == "rect":
                    ...
                    pygame.draw.rect(canvas, current_color, pygame.Rect(start_pos, (side, side)), thickness)
                elif mode == "r_triangle":
                    pygame.draw.polygon(canvas, current_color, [start_pos, (start_pos[0], end_pos[1]), end_pos], thickness)
                    ...
                    pygame.draw.polygon(canvas, current_color, [
                        ...
                        (start_pos[0] + side_length // 2, start_pos[1] - int(side_length * (3**0.5) / 2))
                    ], thickness)
                elif mode == "rhombus":
                    pygame.draw.polygon(canvas, current_color, [
                        (start_pos[0], start_pos[1] - (end_pos[1] - start_pos[1]) // 2),
            ...
            if drawing and mode == "pencil":
                pygame.draw.line(canvas, current_color, prev_pos, event.pos, thickness)
                prev_pos = event.pos
